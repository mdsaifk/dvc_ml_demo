...
def split_and_save_data(config_path,params_path):
    ...
    raw_local_path = os.path.join(artifacts_dir,raw_local_dir,raw_local_file)
    ...
    split_data_dir = config['artifacts']['split_data_dir']  #create directory in local using create diretory
    ...
    for data ,data_path in (train,train_data_filename),(test,test_data_filename):
